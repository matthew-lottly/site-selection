...
def fetch(geo_ids: str, release: str = "acs2024_5yr") -> dict:
    resp = requests.get(
        CENSUS_REPORTER.replace("/show/latest", f"/show/{release}"),
...
def main() -> None:
    ...
    city = fetch("16000US4835000")["data"]["16000US4835000"]
    ...
    veh_zero_rate_moe = ratio_moe(veh_zero_est, veh_zero_moe, veh_tot_est, veh_tot_moe)
    ...
    renter_rate_moe = ratio_moe(renter_est, renter_moe, ten_tot_est, ten_tot_moe)
